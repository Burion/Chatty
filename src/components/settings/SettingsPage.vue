    ...
    <div class="container-settings">
      ...
      <div class="grid-auto-rows-5">
        <div class="settings-item">
          <div class="text-semi-small">Displayed name</div>
          <input type="text" class="input" v-model="currentUser.value.name" />
        </div>
        <div class="settings-item">
          <div class="text-semi-small">Login</div>
          <input type="text" class="input" v-model="currentUser.value.login" />
        </div>
        <div class="settings-item">
          <div class="text-semi-small">Password</div>
          <input type="password" class="input" />
        </div>
        <div class="settings-item">
          <div class="text-semi-small">Confirm password</div>
          <input type="password" class="input" />
        </div>
      </div>
      <button @click="$router.push('/chat')" class="button settings-save">Save</button>
    </div>
  </the-centered-flex>
</template>
